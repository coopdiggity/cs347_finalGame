...
public class BackgroundBehavior : MonoBehaviour
{
    ...
    {
        var PyramidClone = Instantiate(pyramid, new Vector3(transform.position.x + 50, 1, 300), Quaternion.identity);
    ...
    {
        var PyramidClone = Instantiate(pyramid, new Vector3(transform.position.x + 300, 1, 300), Quaternion.identity);
        //ObstacleClone.GetComponent<Rigidbody>().velocity = -1 * transform.localScale.x * waterDropClone.transform.up;
    ...
    {
        var PyramidClone = Instantiate(pyramid, new Vector3(transform.position.x + 350, 1, 300), Quaternion.identity);
        //ObstacleClone.GetComponent<Rigidbody>().velocity = -1 * transform.localScale.x * waterDropClone.transform.up;
